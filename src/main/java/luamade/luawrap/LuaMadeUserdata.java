...
public abstract class LuaMadeUserdata extends LuaUserdata {
	...
	private static final Map<Class<? extends LuaMadeUserdata>, Map<String, WrapMethod>> methodWraps = new HashMap<>();
	private static final Map<Class<? extends LuaMadeUserdata>, Map<String, LuaFunction>> apiMethods = new HashMap<>();
	private static final Map<Class<? extends LuaMadeUserdata>, Set<String>> methods = new HashMap<>();
	 ...
	 */
	private static LuaFunction bindSelf(LuaMadeUserdata self, LuaFunction function) {
		return new VarArgFunction() {
			...
			public Varargs invoke(Varargs vargs) {
				...
				return function.invoke(varargsOf(self, vargs));
			}
		};
	}
